...
To use the interactive plots, open the [interactive_plots_colab.ipynb](interactive_plots_colab.ipynb) file in Google Colab [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MollySQuinn/interactive_unexpected_events/blob/main/interactive_plots_colab.ipynb) 
The last cell defines the DASH app and will display the app in-line in the notebook.
